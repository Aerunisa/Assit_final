...
import '../modules/data_emp/bindings/data_emp_binding.dart';
import '../modules/data_emp/views/data_emp_view.dart';
import '../modules/data_presensi/bindings/data_admin_binding.dart';
import '../modules/data_presensi/views/data_admin_view.dart';
...
class AppPages {
  ...
  static final routes = [
    ...
    GetPage(
      name: _Paths.DATA_EMPLOY,
      page: () => const DataEmpView(),
      binding: DataEmpBinding(),
    ),
  ];
}
