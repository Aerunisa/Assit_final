      ...
      case 1:
        ...
        if (dataResponse["error"] != true) {
          ...
          double distance = Geolocator.distanceBetween(
              -6.3498233, 106.9085833, position.latitude, position.longitude);
          ...
          Get.snackbar("Error, Terjadi Kesalahan", dataResponse["message"]);
        }
        break;
      case 2:
        pageIndex.value = i;
  ...
  Future<void> presensi(
    ...
    if (snapPresence.docs.isEmpty) {
      ...
      await Get.defaultDialog(
        ...
        middleText:
            "Are you sure you want to fill in the attendance list (SIGN IN) now ?",
          ...
          ElevatedButton(
            onPressed: () async {
              ...
              Get.snackbar("Successful",
                  "You have filled out the attendance list (LOGIN)");
      ...
      if (todayDoc.exists == true) {
        ...
        if (dataPresenceToday?["keluar"] != null) {
          ...
          Get.snackbar("Important!",
              "You have been logged in and out. Cannot change data again.");
          //"Informasi Penting","Kamu telah absen masuk & keluar. Tidak dapat mengubah data kembali.");
        } else {
          // absen keluar
          await Get.defaultDialog(
            title: "Validasi Presensi",
            middleText:
                "Are you sure you want to fill in the attendance list (OUT) now?",
            ...
            actions: [
              ...
              ElevatedButton(
                onPressed: () async {
                  ...
                  Get.back();
                  Get.snackbar("Successful",
                      "You have filled out the attendance list (OUT)");
  ...
  Future<Map<String, dynamic>> determinePosition() async {
    ...
    if (permission == LocationPermission.denied) {
      ...
      if (permission == LocationPermission.denied) {
        ...
        return {
          "message": "Permission to use GPS denied.",
    ...
    if (permission == LocationPermission.deniedForever) {
      ...
      return {
        "message":
            "Your cellphone settings don't allow access to GPS. Change your cellphone settings.",
    ...
    return {
      "position": position,
      "message": "Successfully got device position.",
